    ...
    try {
        ...
        pipeline
            .add("appsrc", "appsrc", "do-timestamp", true, "caps", appsrcCaps, "blocksize",
                 blockSize)
            .add("nvvideoconvert", "converter1", "nvbuf-memory-type", nvbufMemoryType, "compute-hw",
                 1)
            ...
            .add("nvstreammux", "mux", "width", width, "height", height, "batch-size", 1,
                 ...
                 "nvbuf-memory-type", nvbufMemoryType, "compute-hw", 1)
            .add("nvinfer", "infer", "config-file-path", CONFIG_FILE_PATH)
            .add("nvvideoconvert", "converter2", "nvbuf-memory-type", nvbufMemoryType, "compute-hw",
                 1)
