...
// cuosd_measure_text: API to get tight width, height and upper offset from the given text's tight
// bounding box
...
// x0, y0 stands for start point coordinate of the line, and x1, y1 stands for end point coordinate
// of the line.
...
// x0, y0 stands for start point coordinate of the arrow, and x1, y1 stands for end point coordinate
// of the arrow.
...
// The region of interest is first scaled to 32x32, filtered, and then scaled to the region of
// interest by nearest neighbor interpolation It is executed by a separate kernel function that is
// independent from the other drawing functions
...
// If format is BlockLinearNV12, data0 and data1 is cudaSurfaceObject_t for Luma(Y) plane and
// Chroma(UV) plane If format is PitchLinearNV12, data0 is Luma(Y) plane buffer, and data1 is
// Chroma(UV) plane buffer
