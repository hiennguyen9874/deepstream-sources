...
static JsonObject *generate_analytics_module_object(NvDsMsg2pCtx *ctx, NvDsEventMsgMeta *meta)
{
    NvDsPayloadPriv *privObj = NULL;
...
static JsonObject *generate_object_object(NvDsMsg2pCtx *ctx, NvDsEventMsgMeta *meta)
{
