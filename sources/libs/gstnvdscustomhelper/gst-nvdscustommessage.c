...
{
    GstStructure *str = gst_structure_new(PIPELINE_RTSP_RECONNECT_ATTEMPT_STRUCT_NAME, "source-id",
                                          G_TYPE_UINT, rtsp_info->source_id, "attempt_exceeded",
                                          G_TYPE_BOOLEAN, rtsp_info->attempt_exceeded, NULL);
