...
#define __DS3D_ERR_STR_DEF(code) {ErrCode::code, #code}
            __DS3D_ERR_STR_DEF(kGood),
            __DS3D_ERR_STR_DEF(kByPass),
            __DS3D_ERR_STR_DEF(kLoadLib),
            __DS3D_ERR_STR_DEF(kMem),
            __DS3D_ERR_STR_DEF(kParam),
            __DS3D_ERR_STR_DEF(kNotFound),
            __DS3D_ERR_STR_DEF(kTimeOut),
            __DS3D_ERR_STR_DEF(kTypeId),
            __DS3D_ERR_STR_DEF(kNvDsMeta),
            __DS3D_ERR_STR_DEF(kUnsupported),
            __DS3D_ERR_STR_DEF(kUnknown),
            __DS3D_ERR_STR_DEF(kConfig),
            __DS3D_ERR_STR_DEF(kRealSense),
            __DS3D_ERR_STR_DEF(kNullPtr),
            __DS3D_ERR_STR_DEF(kOutOfRange),
            __DS3D_ERR_STR_DEF(kGst),
            __DS3D_ERR_STR_DEF(kState),
            __DS3D_ERR_STR_DEF(kGL),
...
#undef __DS3D_DATATYPE_BYTES
    ...
    ShapeSize(const Shape &shape)
    {
        ...
        if (std::any_of(shape.d, shape.d + shape.numDims, [](int d)
                        { return d <= 0; }))
        {
            assert(false);
            return 0;
        ...
        return (size_t)std::accumulate(
            shape.d, shape.d + shape.numDims, 1, [](int s, int i)
            { return s * i; });
    }
