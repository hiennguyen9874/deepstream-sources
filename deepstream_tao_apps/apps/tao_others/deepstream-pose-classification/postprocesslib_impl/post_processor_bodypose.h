...
public:
    ...
    void prcoessMetadata(NvDsInferTensorMeta *tensor_meta,
                         NvDsFrameMeta *frame_meta,
                         NvDsObjectMeta *obj_meta) override;

    void releaseFrameOutput(NvDsPostProcessFrameOutput &frameOutput) override;

private:
    NvDsPostProcessStatus fillBodyPoseOutput(const std::vector<NvDsInferLayerInfo> &outputLayers,
    ...
    void movenetposeFromTensorMeta(const std::vector<NvDsInferLayerInfo> &outputLayers,
                                   NvDsPostProcessBodyPoseOutput &output);
