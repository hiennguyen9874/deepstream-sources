...
int main(int argc, char *argv[])
{
    ...
    GMainLoop *loop = NULL;
    GstCaps *caps = NULL;
    GstElement *streammux = NULL, *pgie = NULL, *sgie = NULL, *postprocess = NULL,
               *preprocess1 = NULL, *sgie1 = NULL;
    ;
    ...
    GstElement *nvvidconv = NULL, *nvtile = NULL, *nvosd = NULL, *tracker = NULL,
               *nvdslogger = NULL;
    ...
    g_object_set(G_OBJECT(nvtile), "rows", tiler_rows, "columns", tiler_columns, "width",
    ...
    gst_bin_add_many(GST_BIN(pipeline), nvvideoconvert_enlarge, capsFilter_enlarge, pgie, tracker,
                     sgie, postprocess, preprocess1, sgie1, nvtile, nvvidconv, nvosd, sink,
                     nvdslogger, nvvideoconvert_reduce, capsFilter_reduce, NULL);

    // Link elements
    if (!gst_element_link_many(streammux, nvvideoconvert_enlarge, capsFilter_enlarge, pgie, tracker,
                               sgie, postprocess, preprocess1, sgie1, nvdslogger,
                               nvvideoconvert_reduce, capsFilter_reduce, nvtile, nvvidconv, nvosd,
                               sink, NULL)) {
