...
#define GST_DSDIRECTION(obj) \
    (G_TYPE_CHECK_INSTANCE_CAST((obj), GST_TYPE_DSDIRECTION, GstDsDirection))
#define GST_DSDIRECTION_CLASS(klass) \
    (G_TYPE_CHECK_CLASS_CAST((klass), GST_TYPE_DSDIRECTION, GstDsDirectionClass))
#define GST_DSDIRECTION_GET_CLASS(obj) \
    (G_TYPE_INSTANCE_GET_CLASS((obj), GST_TYPE_DSDIRECTION, GstDsDirectionClass))
