...
int main(int argc, char *argv[])
{
    ...
    GstElement *pipeline = NULL, *source = NULL, *h264parser = NULL, *decoder = NULL,
               *streammux = NULL, *sink = NULL, *primary_detector = NULL,
    ...
    gst_bin_add_many(GST_BIN(pipeline), source, h264parser, decoder, streammux, primary_detector,
                     secondary_detector, nvvidconv, nvosd, sink, NULL);
    ...
    if (!gst_element_link_many(streammux, primary_detector, secondary_detector, nvvidconv, nvosd,
                               sink, NULL)) {
